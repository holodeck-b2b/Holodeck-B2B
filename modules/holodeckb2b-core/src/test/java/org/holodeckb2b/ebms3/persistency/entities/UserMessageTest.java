...
public class UserMessageTest {
    ...
    private static final String T_MPC_1 = "http://test-mpc/very_long_mpc_value/"
    ...
    public static void cleanup() throws DatabaseException {
        ...
        final Collection<UserMessage> tps = em.createQuery("from UserMessage", UserMessage.class).getResultList();

        for(final UserMessage mu : tps)
            em.remove(mu);
    ...
    public void test01_SetMPC() {
        final UserMessage instance = new UserMessage();
    ...
    public void test02_GetMPC() {
        em.getTransaction().begin();
        final List<UserMessage> tps = em.createQuery("from UserMessage", UserMessage.class).getResultList();
    ...
    public void test03_SetSender() {
        ...
        final TradingPartner sender = new TradingPartner(T_SENDER1_ID, T_SENDER1_ROLE);
    ...
    public void test04_GetSender() {
        ...
        final Iterator<IPartyId> pids = instance.getSender().getPartyIds().iterator();
        if (pids.hasNext()) {
    ...
    public void test05_ChangeSender() {
        ...
        UserMessage instance;
        final TradingPartner sender = new TradingPartner(T_SENDER2_ID, T_SENDER2_ROLE);
    ...
    public void test06_SetReceiver() {
        ...
        final List<UserMessage> tps = em.createQuery("from UserMessage", UserMessage.class).getResultList();
        UserMessage instance;
        final TradingPartner receiver = new TradingPartner(T_RECEIVER1_ID, T_RECEIVER1_ROLE);
    ...
    public void test07_GetReceiver() {
        ...
        // Detach to check eagerly loaded
        em.detach(instance);

        final Iterator<IPartyId> pids = instance.getReceiver().getPartyIds().iterator();
        if (pids.hasNext()) {
    ...
    public void test08_ChangeReceiver() {
        ...
        List<UserMessage> tps = em.createQuery("from UserMessage", UserMessage.class).getResultList();
        UserMessage instance;
        final TradingPartner receiver = new TradingPartner(T_SENDER2_ID, T_SENDER2_ROLE);
    ...
    public void test09_SetCollaborationInfo() {
        ...
        final List<UserMessage> tps = em.createQuery("from UserMessage", UserMessage.class).getResultList();
        UserMessage instance;
        final CollaborationInfo colInfo = new CollaborationInfo(T_COLLABINFO_SVC, T_COLLABINFO_ACTION, T_COLLABINFO_PMODE);
    ...
    public void test12_GetMessageProperties() {
        ...
        final Collection<IProperty> properties = tps.get(0).getMessageProperties();

        assertEquals(2, properties.size());

        // Detach to check properties are already eagerly loaded
        em.detach(tps.get(0));
    ...
    public void test14_SetPayloads() {
        final List<Payload>   pls = new ArrayList<>();
    ...
    public void test15_GetPayloads() {
        ...
        // Detach to check that payloads where eagerly loaded
        em.detach(tps.get(0));

        for(final IPayload pl : tps.get(0).getPayloads()) {
...
//        em.persist(T_PROCSTATE_2);
    ...
    public void test25_GetProcessingStates() {
        ...
        instance = (UserMessage) em.find(MessageUnit.class, instance.getOID());

        assertEquals(2, instance.getProcessingStates().size());
    ...
    public void test28_isDeliveredQuery() {
        ...
        final List<UserMessage> tps = em.createQuery("from UserMessage", UserMessage.class).getResultList();
        final UserMessage instance = tps.get(0);

        final String msgId = instance.getMessageId();

        final ProcessingState delivered = new ProcessingState(ProcessingStates.DELIVERED);
        em.persist(delivered);
        instance.setProcessingState(delivered);

        em.persist(instance);

        em.getTransaction().commit();

        final Boolean result = new Boolean(em.createNamedQuery("UserMessage.isDelivered",
                                            String.class)
    ...
    public void test29_numOfRetransmitsQuery() {
        ...
        instance.setProcessingState(procstate);
        ...
        em.persist(procstate);
        instance.setProcessingState(procstate);
        procstate = new ProcessingState(ProcessingStates.SENDING);
        em.persist(procstate);
        instance.setProcessingState(procstate);
        procstate = new ProcessingState(ProcessingStates.AWAITING_RECEIPT);
        em.persist(procstate);
        instance.setProcessingState(procstate);
        ...
        procstate = new ProcessingState(ProcessingStates.READY_TO_PUSH); em.persist(procstate);
        instance.setProcessingState(procstate);
        procstate = new ProcessingState(ProcessingStates.PROCESSING); em.persist(procstate);
        instance.setProcessingState(procstate);
        procstate = new ProcessingState(ProcessingStates.SENDING); em.persist(procstate);
        instance.setProcessingState(procstate);
        procstate = new ProcessingState(ProcessingStates.AWAITING_RECEIPT); em.persist(procstate);
        instance.setProcessingState(procstate);
        procstate = new ProcessingState(ProcessingStates.READY_TO_PUSH); em.persist(procstate);
        instance.setProcessingState(procstate);
        procstate = new ProcessingState(ProcessingStates.PROCESSING); em.persist(procstate);
