...
//            final String path = this.getClass().getClassLoader().getResource("mmdtest/mmdtest3.xml").getPath();
    ...
    public void test_CreateFromObject() {
        ...
        final org.holodeckb2b.ebms3.persistency.entities.CollaborationInfo ci = new org.holodeckb2b.ebms3.persistency.entities.CollaborationInfo();
        ci.setAction(T_UM1_ACTION);
        ci.setConversationId(T_UM1_CONVID);
        final org.holodeckb2b.ebms3.persistency.entities.Service svc = new org.holodeckb2b.ebms3.persistency.entities.Service(T_UM1_SERVICE);
        ci.setService(svc);
        final org.holodeckb2b.ebms3.persistency.entities.AgreementReference agreeRef = new org.holodeckb2b.ebms3.persistency.entities.AgreementReference(T_UM1_PMODEID);
