...
/**
 * Represent the standard <i>InvalidHeader</i> error as defined in section 6.7 of the Core specification.
 *
 * @author Sander Fieten (sander at holodeck-b2b.org)
 */
public class InvalidHeader extends org.holodeckb2b.common.messagemodel.EbmsError {
    ...
    /**
     * Constructs a new <i>InvalidHeader</i> error with specified detail message
     *
     * @param errorDetail       A more detailed description of the error
     */
    public InvalidHeader(final String errorDetail) {
        this();
        setErrorDetail(errorDetail);
    }

   /**
     * Constructs a new <i>InvalidHeader</i> error with specified detail message and that refers to the given
     * message id
     *
     * @param errorDetail       A more detailed description of the error
     * @param refToMessageId    The message id of the message unit for which this error is created
     */
    public InvalidHeader(final String errorDetail, final String refToMessageId) {
        this();
        setErrorDetail(errorDetail);
