 ...
 * <o>org.holodeckb2b.core.submission.SubmissionLog</p> log. Which meta-data is logged depends on the log level and is
 ...
 * <code>type</type> <i>urn:org:holodeckb2b:example:pid</i> and <type>value</type> <i>PartyA</i> the logged text would 
 * be <i>[urn:org:holodeckb2b:example:pid]PartyA</i>.<br> 
