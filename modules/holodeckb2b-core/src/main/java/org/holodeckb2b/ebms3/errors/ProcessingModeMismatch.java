...
/**
 * Represent the standard <i>ProcessingModeMismatch</i> error as defined in section 6.7 of the Core specification.
 *
 * @author Sander Fieten <sander at holodeck-b2b.org>
 */
public class ProcessingModeMismatch extends org.holodeckb2b.common.messagemodel.EbmsError {
    ...
    /**
     * Constructs a new <i>ProcessingModeMismatch</i> error with specified detail message
     *
     * @param errorDetail       A more detailed description of the error
     */
    public ProcessingModeMismatch(final String errorDetail) {
        this();
        setErrorDetail(errorDetail);
    }

   /**
     * Constructs a new <i>ProcessingModeMismatch</i> error with specified detail message and that refers to the given
     * message id
     *
     * @param errorDetail       A more detailed description of the error
     * @param refToMessageId    The message id of the message unit for which this error is created
     */
    public ProcessingModeMismatch(final String errorDetail, final String refToMessageId) {
        this();
        setErrorDetail(errorDetail);
