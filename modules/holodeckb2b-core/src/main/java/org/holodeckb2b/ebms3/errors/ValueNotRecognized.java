...
/**
 * Represent the standard <i>ValueNotRecognized</i> error as defined in section
 ...
 */
public class ValueNotRecognized extends EbmsError {
    
    /**
     * The error code as defined in the core specification
     */
    private static final String ERROR_CODE = "EBMS:0001";
     ...
     */
    private static final String ERROR_SHORT_DESCRIPTION = "ValueNotRecognized";
