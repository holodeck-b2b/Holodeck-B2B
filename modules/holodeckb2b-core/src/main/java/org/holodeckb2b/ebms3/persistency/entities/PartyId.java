...
/**
 * Is the JPA persistency class for storing <i>PartyId</i> information. As a PartyId is not a very useful entity on its 
 * own but always related to another entity (a business partner in some role) it is defined as a <i>embeddable</i>.
 * 
