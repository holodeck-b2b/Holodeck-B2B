...
public class CheckForResponse extends AbstractMessageReceiver {
    ...
    protected void invokeBusinessLogic(MessageContext messageCtx) throws AxisFault {
        ...
        Boolean responseRequired = (Boolean) messageCtx.getProperty(MessageContextProperties.RESPONSE_REQUIRED);
     ...
     *                      message context
     */
    protected MessageContext createResponseContext(MessageContext msgContext) throws AxisFault {
