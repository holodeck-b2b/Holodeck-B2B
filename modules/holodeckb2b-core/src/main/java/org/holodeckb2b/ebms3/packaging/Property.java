...
public class Property {
     ...
     */
    public static OMElement createElement(OMElement parent, IProperty data) {
        OMFactory f = parent.getOMFactory();
        
        // Create the element
        OMElement property = f.createOMElement(Q_ELEMENT_NAME, parent);
    ...
    public static org.holodeckb2b.ebms3.persistent.general.Property readElement(OMElement propElement) throws PackagingException {
        ...
        String name = propElement.getAttributeValue(new QName(LN_ATTR_NAME));
