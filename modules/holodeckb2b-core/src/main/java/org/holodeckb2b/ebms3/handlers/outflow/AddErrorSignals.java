...
//        try {
//            errorSigs = (Collection<EntityProxy<ErrorMessage>>) mc.getProperty(MessageContextProperties.OUT_ERRORS);
//        } catch(final ClassCastException cce) {
//            log.fatal("Illegal state of processing! MessageContext contained a " + mc.getProperty(MessageContextProperties.OUT_ERRORS).getClass().getName()
...
//        final Collection<EntityProxy<ErrorMessage>> errsToAdd = getBundableErrors(primaryMU);
...
//        for(final EntityProxy<ErrorMessage> e : errsToAdd) {
...
//     */
//    private Collection<EntityProxy<ErrorMessage>> getBundableErrors(final EntityProxy<MessageUnit> primaryMU) {
//        final ArrayList<EntityProxy<ErrorMessage>> errors = new ArrayList<>();
...
//        try {
//            final Collection<EntityProxy<ErrorMessage>> createdErrors =
...
//            final Collection<EntityProxy<ErrorMessage>> failedErrors =
//                                    MessageUnitDAO.getMessageUnitsForPModesInState(ErrorMessage.class,
//                                                                                   pmodes,
