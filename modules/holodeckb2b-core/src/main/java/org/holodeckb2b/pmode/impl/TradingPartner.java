...
public class TradingPartner implements ITradingPartner {
    ...
    /**
     * Get the TradpingPartner party id's.
     * 
    ...
    /**
     * Set the TradingPartner party id's.
     * @param Collection of PartyID's. 
     */
    ...
    /**
     * Set the TradingPartner role.
     * @param role The role of the TradingPartner to be set.
     */
