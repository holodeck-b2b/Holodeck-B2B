...
* `getService()` to public Holodeck B2B Core interface 
* `getTransportSender()` to public Holodeck B2B Core interface 
* `createServiceClient()` to public Holodeck B2B Core interface
