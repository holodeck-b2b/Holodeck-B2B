...
* The configuration parameters related to the keystores used in WS-Security processing. By enabling
  _compatability mode_ in the new default security provider the functionality of the old version is still
  supported.
